...
<?php include './partials/search.php'?>  
                        ...
                        <div class="mega-menu-wrapper">
                            <div class="header-main">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="has-dropdown">
                                                        ...
                                                        <ul class="submenu">
                                                            ...
                                                            <li><a href="about-2.php">About Us 02</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <ul class="submenu">
                                                            <li class="has-dropdown">
                                                                ...
                                                                <ul class="submenu">
                                                                    ...
                                                                    <li><a href="chef-details.php">Chef Details 01</a>
                                                                    </li>
                                                                    <li><a href="chef-details2.php">Chef Details 02</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li class="has-dropdown">
                                                                ...
                                                                <ul class="submenu">
                                                                    <li><a href="menu.php">Food Menu 01</a></li>
                                                                    <li><a href="menu2.php">Food Menu 02</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li class="has-dropdown">
                                                                ...
                                                                <ul class="submenu">
                                                                    ...
                                                                    <li><a href="gallery-bento-grid.php">Gallery Bento
                                                                            Grid</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="has-dropdown">
                                                                <a href="services-1.php">
                                                                    Services
                                                                    <i class="fas fa-angle-down"></i>
                                                                </a>
                                                                <ul class="submenu">
                                                                    <li>
                                                                        <a href="services-1.php">Services 01</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="services-2.php">Services 02</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="service-details.php">Service
                                                                            Details</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li class="has-dropdown">
                                                                ...
                                                                <ul class="submenu">
                                                                    <li><a href="testimonials-1.php">Testimonials
                                                                            01</a></li>
                                                                    <li><a href="testimonials-2.php">Testimonials
                                                                            02</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="submenu">
                                                            <li><a href="contact.php">Contact Us 01</a></li>
                                                            <li><a href="contact2.php">Contact Us 02</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </nav>
                                ...
                                <div class="header-right d-flex justify-content-end align-items-center">
                                    ...
                                    <a class="theme-btn style4 pe-2 ps-0 rounded-5" href="menu.php"> <i
    ...
    <section class="banner-section fix">
        <div class="slider-area">
            <div class="swiper banner3-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="banner-wrapper style3 bg-img">
                            <div class="shape1  d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".3s">
                                <img class="float-bob-y" src="assets/img/shape/bannerShape3_1.svg" alt="shape">
                            </div>
                            <div class="shape2  d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay=".5s">
                                <img class="float-bob-x" src="assets/img/shape/bannerShape3_2.svg" alt="shape">
                            </div>
                            <div class="shape3 d-none d-xxl-block" data-tilt data-tilt-max="4"
                                data-animation="slideInLeft" data-duration="2s" data-delay=".8s">
                                <img src="assets/img/shape/bannerShape3_3.png" alt="shape">
                            </div>
                            <div class="shape4 d-none d-xxl-block" data-animation="slideInLeft" data-duration="2s"
                                data-delay="1s">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="banner-style3">
                                            <div class="subtitle" data-animation="slideInRight" data-duration="2s"
                                                data-delay=".3s">signature</div>
                                            <h1 class="title" data-animation="slideInRight" data-duration="2s"
                                                data-delay=".7s">
                                                <span>SEA</span> FOODS
                                            </h1>
                                            <p data-animation="slideInRight" data-duration="2s" data-delay="2s">Every
                                                dish is not just prepared it's a crafted with a savor the a utmost
                                                precision and a deep understanding sdf of flavor Every dish is not just
                                                prepared it's a crafted with a savor</p>
                                        </div>
                            ...
                            <div class="banner-bottom  z-3 position-relative">
                                <div class="container-fluid  d-flex align-items-center justify-content-between">
                                    <div class="fancy-item">
                                        <i class="fa-solid fa-location-dot text-theme-color2"></i> <span
                                            class=" text-white">Rd. Santa Ana, Illinois 85486, United States</span>
                                    </div>
                                    <div class="social-meta d-flex  flex-column flex-md-row align-items-center gap-2">
                                        <p class="text-white">Follow Us:</p>
                                        <ul class="d-flex align-items-center gap-2">
                                            <li><a href="https://www.facebook.com"><i
                                                        class="fa-brands fa-facebook text-white"></i></a></li>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="banner-style3">
                                            ...
                                            <p data-animation="slideInLeft" data-duration="2s" data-delay="1s">Every
                                                dish is not just prepared it's a crafted with a savor the a utmost
                                                precision and a deep understanding sdf of flavor Every dish is not just
                                                prepared it's a crafted with a savor</p>
                                        </div>
                ...
                <div class="arrow-prev3"><img src="assets/img/icon/arrowPrev.svg" alt="Icon"></div>
                <div class="arrow-next3"><img src="assets/img/icon/arrowNext.svg" alt="Icon"></div>
                <div class="pagination-class3 swiper-pagination"></div>
            </div>
        </div>
    </section>

    <!-- Popular Dishes Section   S T A R T -->
    <section class="popular-dishes-section fix section-padding pb-0">
        <div class="popular-dishes-wrapper-container">
            <div class="container">
                <div class="popular-dishes-wrapper style4">
                    <div class="shape1 float-bob-x d-none d-xxl-block"><img src="assets/img/shape/dishesShape5_1.png"
                            alt="shape"></div>
                    <div class="container">
                        ...
                        <div class="dishes-card-wrap style4">
                            <div class="dishes-card style5 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="dishes-thumb">
                                    <img src="assets/img/dishes/dishes6_1.png" alt="thumb">
                                </div>
                                <div class="dishes-content">
                                    ...
                                    <h6>$28.00</h6>
                                    <a href="menu.php" class="theme-btn style6"> Order Now <i
                                            class="fa-regular fa-basket-shopping"></i></a>
                                </div>
                            </div>
                            <div class="dishes-card style5 wow fadeInUp" data-wow-delay="0.6s">
                                <div class="dishes-thumb">
                                    <img src="assets/img/dishes/dishes6_2.png" alt="thumb">
                                </div>
                                <div class="dishes-content">
                                    <a href="menu.php">
                                        <h3>Crab Cakes</h3>
                            ...
                            <div class="dishes-card style5 wow fadeInUp" data-wow-delay="0.8s">
                                <div class="dishes-thumb">
                                    <img src="assets/img/dishes/dishes6_3.png" alt="thumb">
                                </div>
                                <div class="dishes-content">
                                    <a href="menu.php">
                            ...
                            <div class="dishes-card style5 wow fadeInUp" data-wow-delay="0.9s">
                                <div class="dishes-thumb">
                                    <img src="assets/img/dishes/dishes6_4.png" alt="thumb">
                                </div>
                                <div class="dishes-content">
                                    <a href="menu.php">
                                        <h3>Shrimp Scampi</h3>
    ...
    <div class="about-section fix">
        <div class="about-wrapper section-padding  style3">
            <div class="shape1"><img class="float-bob-y" src="assets/img/shape/aboutShape3_1.png" alt="shape"></div>
            <div class="shape2"><img class="float-bob-x" src="assets/img/shape/aboutShape3_2.png" alt="shape"></div>
            <div class="orange-shape"><img src="assets/img/about/orange-shape.png" alt="shape"></div>
            <div class="container">
                    ...
                    <div class="col-xl-6">
                        <div class="about-content">
                            <div class="title-area">
                                ...
                                <div class="text text-start wow fadeInUp" data-wow-delay="0.8s">It is a long established
                            ...
                            <div class="fancy-box-wrapper">
                                <div class="fancy-box">
                                    <div class="item"><img src="assets/img/icon/aboutIcon2_1.svg" alt="icon"></div>
                                    <div class="item">
                                ...
                                <div class="fancy-box">
                                    <div class="item"><img src="assets/img/icon/aboutIcon2_2.svg" alt="icon"></div>
                                    <div class="item">
                            ...
                            <a href="about-2.php" class="theme-btn style4">
                                ABOUT US <i class="fa-sharp fa-regular fa-arrow-right"></i>
                            </a>
                        </div>
    ...
    <section class="food-menu-section fix">
        <div class="food-menu-wrapper style3">
            <div class="container">
                <div class="food-menu-tab-wrapper style3 section-padding bg-dark rounded-5">
                    <div class="shape1 d-none d-xl-block"><img class="float-bob-x"
                            src="assets/img/shape/foodmenuShape3_1.png" alt="shape"></div>
                    <div class="shape2 d-none d-xl-block"><img class="float-bob-y"
                            src="assets/img/shape/foodmenuShape3_2.png" alt="shape"></div>
                    <div class="shape3 d-none d-xl-block"><img class="float-bob-y"
                            src="assets/img/shape/foodmenuShape3_3.png" alt="shape"></div>
                    <div class="title-area">
                        <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                            <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon"> DELICIOUS DISHES <img
                                class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                        </div>
                        <h2 class="title wow fadeInUp" data-wow-delay="0.7s">
                            Getting You Hungry
                    ...
                    <div class="food-menu-tab style2">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-Snack-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-Snack" type="button" role="tab" aria-controls="pills-Snack"
                                    aria-selected="false">Snack</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-Suops-tab" data-bs-toggle="pill"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="single-menu-items">
                                            <div class="details">
                                                <div class="menu-content">
                                                    <a href="menu.php">
                                                        <h3 class="active">Crispy Calamari</h3>
                                                    </a>
                                                    <p>It's a testament to our commitment to sustainability, quality,
                            ...
                            <div class="tab-pane fade" id="pills-Drink" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="pills-Snack" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="pills-Suops" role="tabpanel"
        ...
        <div class="marquee-wrapper style-1 section-padding mb-5">
            <div class="marquee-inner to-left">
                <ul class="marqee-list d-flex">
                    <li class="marquee-item style1">
                        <span class="text-slider"></span><span class="text-slider text-style">French Onion Soup</span>
                        <span class="text-slider"></span><span class="text-slider text-style">Chelled Sea Food</span>
    ...
    <div class="offer-section section-padding fix bg-title">
        <div class="offer-shape">
            <img src="assets/img/offer/offer-shape.png" alt="img">
        </div>
        <div class="offer-wrapper3">
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6">
                        <div class="offer-card style1 rounded-5 wow fadeInUp" data-wow-delay="0.5s"
                    ...
                    <div class="col-lg-6">
                        <div class="offer-card style1  rounded-5  wow fadeInUp" data-wow-delay="0.7s"
    ...
    <!-- History Section    S T A R T -->
    <section class="history-section fix  bg-title">
        ...
        <div class="container">
            <div class="history-wrapper style1">
                <div class="row gx-60">
                    <div class="col-lg-8">
                        <div class="history-thumb mt-5 mt-lg-0">
                            <img class="thumb" src="assets/img/history/historyThumb1_1.jpg" alt="thumb">


                            <div class="video-wrap ripple-effect">
                                <a href="https://www.youtube.com/watch?v=f2Gzr8sAGB8" class="play-btn popup-video"><img
                                        class="playerImg" src="assets/img/shape/player2.svg" alt="icon"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="history-content section-padding">
                            <div class="title-area mb-45">
                                <div class="sub-title text-start wow fadeInUp" data-wow-delay="0.5s">
                                    <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon"> Why choose us <img
                                        class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                                </div>
                                <div class="title text-start text-white wow fadeInUp" data-wow-delay="0.7s">
                                    The history of our restaurant
                                </div>

                                <p class="text-white">It is a long established fact that a reader will be distracted the
                                    readable content of a page</p>
                            </div>

                            <div class="fancy-box style6">
                                <div class="item">
                                    <div class="icon">
                                ...
                                <div class="item">
                                    <h6 class="title">Buffet Service</h6>
                                    <p class="text">It is a long established fact that a reader will be distracted the
                                    </p>
                                </div>
                            </div>
                            <div class="fancy-box style6">
                                ...
                                <div class="item">
                                    <h6 class="title">Cook & Sarve Faster</h6>
                                    <p class="text">It is a long established fact that a reader will be distracted the
                                    </p>
                                </div>
                            </div>
    ...
    <div class="faq-section section-padding pb-0 fix">
        <div class="container">
            <div class="faq-wrapper-4">
                <div class="row gy-5 gx-60">
                    <div class="col-xl-6">
                        <div class="title-area mb-45">
                            <div class="sub-title text-start wow fadeInUp" data-wow-delay="0.5s">
                                <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon">Enjoy Our Dishes<img
                                    class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                            </div>
                            <div class="title text-white text-start wow fadeInUp" data-wow-delay="0.7s">
                                We serve and deliver delectable food.
                            </div>
                        </div>
                        <div class="faq-content-3">
                                    ...
                                    <div class="accordion-item wow fadeInUp" data-wow-delay=".4s">
                                        <h4 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-controls="faq2">
                                                Do You Offer Vegetarian / Vegans Options?
                                            </button>
                                        </h4>
                                    ...
                                    <div class="accordion-item wow fadeInUp" data-wow-delay=".6s">
                                        <h4 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-controls="faq3">
                                                Are Kids Allowed in Restaurant?
                                            </button>
                                        </h4>
                    ...
                    <div class="col-xl-6">
                        <div class="faq-image-area">
                            ...
                            <div class="clock-wrapper-area">
                                <h3>Get 30% Discount Every Item</h3>
                                <div class="clock-wrapper">
                                    <div class="clock">
                                        <div class="number" id="days">20</div>
                                        <div class="text">days</div>
                                    </div>
                                    <div class="clock">
                                        <div class="number" id="hours">48</div>
                                        <div class="text">hrs</div>
                                    </div>
                                    <div class="clock">
                                        <div class="number" id="minutes">16</div>
                                        <div class="text">mins</div>
                                    </div>
                                    <div class="clock">
                                        <div class="number" id="seconds">38</div>
     ...
     <div class="brand-section-3 fix section-padding">
        <div class="container">
            <div class="slider-area wow fadeInUp" data-wow-delay="0.5s">
                <div class="swiper clientSliderOne">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="client-img text-center"><img src="assets/img/logo/clientLogoDark1_1.png"
                                    alt="logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-img text-center"><img src="assets/img/logo/clientLogoDark1_2.png"
                                    alt="logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-img text-center"><img src="assets/img/logo/clientLogoDark1_3.png"
                                    alt="logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-img text-center"><img src="assets/img/logo/clientLogoDark1_4.png"
                                    alt="logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-img text-center"><img src="assets/img/logo/clientLogoDark1_5.png"
                                    alt="logo">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-img text-center"><img src="assets/img/logo/clientLogoDark1_6.png"
                                    alt="logo">
                            </div>
                        </div>
                    </div>
    ...
    <section class="contact-section fix bg-color3">
        <div class="contact-wrapper style2 section-padding bg-img">
            <div class="container">
                <div class="row g-0 d-flex justify-content-center">
                    <div class="col-xl-8 z-3 order-2 order-xl-1">
                        <div class="contact-card-wrap">
                            <div class="contact-form-wrapper style2">
                                <div class="contact-form style2 rounded-0 bg-dark">
                                    <div class="title-area mx-492 mx-auto">
                                        <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                                            <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon"> Book Your
                                            Seat <img class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                                        </div>
                                        <h2 class="title text-center  wow fadeInUp" data-wow-delay="0.7s">
                                    ...
                                    <form class="row" action="#">
                                        ...
                                        <div class="col-md-6">
                                            <select name="guest" class="single-select" aria-label="guest number">
                                                <option value="subject" selected="selected">Guest</option>
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <label for="reviewcheck">Collaboratively formulate principle capital.
                                                Progressively
                                                evolve user<span class="checkmark"></span></label>
                                        </div>
                                        <div class="col-12 form-group mb-0">
                                            <button class="theme-btn w-100"> MAKE A RESERVATION <i
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 wow fadeInUp bg-title " data-wow-delay="0.2s">
                        <div class="opening-details py-5">
                            <div class="title-area mx-492 mx-auto">
                                <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                                    <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon"> Reservation <img
                                        class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                                </div>
                                <h2 class="title text-white text-center  wow fadeInUp" data-wow-delay="0.7s">
                                    Opening Time
                                </h2>
                            </div>
                            ...
                            <div class="number">+1 303 404 608</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="testimonial-section section-padding pb-0 fix">
        ...
        <div class="testimonial-wrapper style3">
            <div class="container">
                <div class="title-area">
                    <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                        <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon">Testimonials<img class="ms-1"
                    ...
                    <div class="swiper testmonialSliderThree">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-card style3">
                                    <div class="testimomnial-thumb">
                                        <img src="assets/img/testimonial/testimonialProfile3_1.png" alt="img">
                                    </div>
                                    <div class="testimonial-body">
                                        <div class="icon"><img src="assets/img/icon/star2.svg" alt="icon"></div>

                                        <p>There are many variations digof passages of Lorem Ipsum available,d like
                                            digital agency but the majority have suffered nalteration in some form, by
                                            injected humour,</p>
                                        ...
                                        <div class="fancy-box">
                                            ...
                                            <div class="quote"><img src="assets/img/icon/quote.svg" alt="icon"> </div>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card style3">
                                    <div class="testimomnial-thumb">
                                        <img src="assets/img/testimonial/testimonialProfile3_2.png" alt="img">
                                    </div>
                                    <div class="testimonial-body">
                                        <div class="icon"><img src="assets/img/icon/star2.svg" alt="icon"></div>
    ...
    <div class="wcu-section section-padding fix bg-dark">
                ...
                <div class="row gy-5 gx-80 d-flex align-items-center">
                    <div class="col-md-6 order-2 order-md-1">
                        <div class="wcu-content">
                            <div class="title-area">
                                <div class="sub-title text-start wow fadeInUp" data-wow-delay="0.5s">
                                    <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon"> Work Process <img
                                        class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                                </div>
                                <h2 class="title text-start wow fadeInUp" data-wow-delay="0.7s">
    ...
    <section class="blog-section section-padding fix">
        <div class="blog-wrapper style2">
            <div class="shape1"><img src="assets/img/shape/blogShape3_1.png" alt="shape"></div>
            <div class="container">
                <div class="blog-card-wrap style2">
                    <div class="title-area">
                        <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                            <img class="me-1" src="assets/img/icon/titleIcon.svg" alt="icon">LATEST BLOG<img
                                class="ms-1" src="assets/img/icon/titleIcon.svg" alt="icon">
                        </div>
                        <h2 class="title wow fadeInUp" data-wow-delay="0.7s">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="blog-card style2 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="blog-thumb">
                                    <img src="assets/img/blog/blogThumb4_1.jpg" alt="thumb">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        ...
                                        <div class="items-wrap">
                                            <div class="item2">
                                                <div class="icon"><i class="fa-light fa-user"></i> <span>By Admin</span>
                                                </div>
                                            </div>
                                            <div class="item3">
                                                <div class="icon"><i
                                                        class="fa-light fa-comments"></i><span>Comments(5)</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="blog-details.php">
                                        <h3>Top 10 Must-Try Dishes at Our Restaurant</h3>
                                    </a>
                                    <p>Get to know the top 10 dishes you must try our fast savor when you visit our
                                        restaurant, Savor fast food from appetizers to desserts...</p>
                        ...
                        <div class="col-lg-4">
                            <div class="blog-card style2 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="blog-thumb">
                                    <img src="assets/img/blog/blogThumb4_2.jpg" alt="thumb">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <div class="item1">
                                        ...
                                        <div class="items-wrap">
                                            ...
                                            <div class="item3">
                                                <div class="icon"><i
                                                        class="fa-light fa-comments"></i><span>Comments(15)</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="blog-details.php">
                                        <h3>Take a behind-the-scenes look at a typical day</h3>
                                    </a>
                                    <p>Get to know the top 10 dishes you must try our fast savor when you visit our
                                        restaurant, Savor fast food from appetizers to desserts...</p>
                                    <a href="blog-details.php" class="link-btn">
                        ...
                        <div class="col-lg-4">
                            <div class="blog-card style2 wow fadeInUp" data-wow-delay="0.6s">
                                <div class="blog-thumb">
                                    <img src="assets/img/blog/blogThumb4_3.jpg" alt="thumb">
                                </div>
                                <div class="blog-content">
                                    <div class="blog-meta">
                                        <div class="item1">
                                    ...
                                    <a href="blog-details.php">
                                        <h3>Learn the secrets to making perfect pasta</h3>
                                    </a>
                                    <p>Get to know the top 10 dishes you must try our fast savor when you visit our
                                        restaurant, Savor fast food from appetizers to desserts...</p>
                                    <a href="blog-details.php" class="link-btn">
