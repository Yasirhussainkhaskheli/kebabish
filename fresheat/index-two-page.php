...
<body class="bg-color2">
    ...
    <section class="about-us-section fix section-padding pt-0" id="about">
    ...
    <section class="cta-section fix">
     ...
     <section class="food-menu-section fix section-padding pt-0" id="menu">
    ...
    <section class="chefe-section fix section-padding pt-0" id="chef">
    ...
    <!-- Cta section  S T A R T -->
    <section class="cta-section style-white fix" id="app">
