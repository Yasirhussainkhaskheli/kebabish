...
<body class="bg-color2">
            ...
            <div class="main-header-wrapper-2">
                ...
                <div class="main-header-items">
                    <div class="header-top-wrapper-2">
                        <div class="text-white top-text">Welcome To <span class="text-theme-color2">Fresheat</span> Fast
                            Food & Restaurant</div>
                        <div class="text-white top-text"><i class="fa-solid fa-location-dot me-3"></i> Rd. Santa Ana,
                            Illinois 85486, United States</div>
                                                        ...
                                                        <ul class="submenu">
                                                            ...
                                                            <li class="has-dropdown">
                                                                ...
                                                                <ul class="submenu">
                                                                    ...
                                                                    <li><a href="service-details.php">Service
                                                                            Details</a></li>
                                                                </ul>
                                                            </li>
                ...
                <div class="popular-dishes-wrapper style2 section-padding bg-white ">
                    ...
                    <div class="container">
                        ...
                        <div class="dishes-card-wrap style1 mb-60">
                            ...
                            <div class="dishes-card style2 wow fadeInUp" data-wow-delay="0.9s">
                                <div class="dishes-thumb">
    ...
    <section class="cta-section fix">
        <div class="cta-wrapper  section-padding pt-xl-0 pb-xl-0 style2">
            <div class="shape1 float-bob-x d-none d-xxl-block"><img src="assets/img/shape/ctaShape2_1.png" alt="shape">
            </div>
            <div class="shape2 float-bob-y d-none d-xxl-block"><img src="assets/img/shape/ctaShape2_2.png" alt="shape">
            </div>
            <div class="shape3 float-bob-y d-none d-xxl-block"><img src="assets/img/shape/ctaShape2_3.png" alt="shape">
            </div>
            <div class="shape4   d-none d-xxl-block"><img src="assets/img/shape/ctaShape2_4.png" alt="shape"></div>
            <div class="shape5   d-none d-xxl-block"><img src="assets/img/shape/ctaShape2_5.png" alt="shape"></div>
            <div class="shape6   d-none d-xxl-block"><img src="assets/img/shape/ctaShape2_6.png" alt="shape"></div>
            <div class="shape7   d-none d-xxl-block"><img class="cir36" src="assets/img/shape/ctaShape2_7.png"
                    alt="shape"></div>
            <div class="container">
                <div class="cta-wrap style2">
                    <div class="row">
                        ...
                        <div
                            class="col-xl-6 d-flex align-items-center justify-content-center justify-content-xl-end order-1 order-xl-2">
                            <div class="cta-thumb">
                                <img class="img-fluid float-bob-x" src="assets/img/cta/ctaThumb2_1.png" alt="thumb">
                            </div>
                        </div>
                    </div>
     ...
     <section class="popular-dishes-section fix section-padding">
        <div class="popular-dishes-wrapper style3">
            <div class="shape1 d-none d-xxl-block"><img src="assets/img/shape/dishesShape3_1.png" alt="shape"></div>
            <div class="shape2 d-none d-xxl-block"><img src="assets/img/shape/dishesShape3_2.png" alt="shape"></div>
            <div class="container">
                <div class="title-area">
                    <div class="sub-title text-center wow fadeInUp" data-wow-delay="0.5s">
                ...
                <div class="slider-area">
                    <div class="swiper popularDishesSliderOne">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="dishes-card style3">
                                    <div class="dishes-thumb">
                                        <img src="assets/img/dishes/dishes3_1.jpg" alt="thumb">
                                        <div class="view-more">
                                            <a href="menu.php">
                                                <h3> VIEW MORE </h3>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="dishes-card style3">
                                    <div class="dishes-thumb">
                                        <img src="assets/img/dishes/dishes3_2.jpg" alt="thumb">
                                        <div class="view-more">
                                            <a href="menu.php">
                                                <h3> VIEW MORE </h3>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="dishes-card style3">
                                    <div class="dishes-thumb">
                                        <img src="assets/img/dishes/dishes3_3.jpg" alt="thumb">
                                        <div class="view-more">
                                            <a href="menu.php">
                                                <h3> VIEW MORE </h3>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="dishes-card style3">
                                    <div class="dishes-thumb">
                                        <img src="assets/img/dishes/dishes3_4.jpg" alt="thumb">
                                        <div class="view-more">
                                            <a href="menu.php">
                                                <h3> VIEW MORE </h3>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="dishes-card style3">
                                    <div class="dishes-thumb">
                                        <img src="assets/img/dishes/dishes3_5.jpg" alt="thumb">
                                        <div class="view-more">
                                            <a href="menu.php">
                                                <h3> VIEW MORE </h3>
                                            </a>
     ...
     <section class="food-menu-section fix section-padding pt-0">
    ...
    <section class="chefe-section fix section-padding pt-0">
    ...
    <!-- Cta section  S T A R T -->
    <section class="cta-section style-white fix">
    ...
    <section class="testimonial-section fix section-padding bg-white">
        <div class="vagetable-shape">
    ...
    <section class="contact-section fix bg-color3">
        ...
        <div class="contact-wrapper style1 section-padding ">
            <div class="shape"><img src="assets/img/contact/contactThumb1_1.png" alt="thumb"></div>
            <div class="shape2"><img src="assets/img/contact/contactThumb1_2.jpg" alt="shape"></div>
            <div class="container">
                        ...
                        <div class="contact-card-wrap">
                            <div class="title-area">
                                <div class="sub-title text-white text-start wow fadeInUp" data-wow-delay="0.5s">
                                    <img class="me-1" src="assets/img/icon/titleIconWhite.svg" alt="icon">CONTACT US<img
                                        class="ms-1" src="assets/img/icon/titleIconWhite.svg" alt="icon">
                                </div>
                            ...
                            <div class="contact-form style1">
                                <form class="row g-3">
                                    ...
                                    <div class="col-md-12 wow fadeInUp" data-wow-delay="0.6s">
                                        ...
                                        <input class="form-control" id="service" placeholder="Total Guests" required>
                                    </div>
                                    ...
                                    <div class="col-12 wow fadeInUp" data-wow-delay="0.9s">
                                        <button type="submit" class="theme-btn style5">
                                            BOOK A TABLE<i class="fa-sharp fa-regular fa-arrow-right"></i>
                                        </button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-xl-7 d-flex align-items-center justify-content-center justify-content-md-center order-1 order-xl-2 wow fadeInUp"
                        ...
                        <div class="video-wrap">
                            <a href="https://www.youtube.com/watch?v=f2Gzr8sAGB8" class="play-btn popup-video"><img
                                    class="cir36" src="assets/img/shape/player.svg" alt="icon"></a>
                        </div>
                    </div>
                </div>
            </div>
