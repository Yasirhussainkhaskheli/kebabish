                        ...
                        <tbody>
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.php"><img src="assets/img/dishes/dishes5_1.png"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.php">Egg and Cucumber</a>
                                </td>
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.php"><img src="assets/img/dishes/dishes5_2.png"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.php">Brick Oven Pepperoni</a>
                                </td>
                                <td class="product-price">
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.php"><img src="assets/img/dishes/dishes5_3.png"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.php">Double Patty Veg</a>
                                </td>
                                <td class="product-price">
                                    <ins><span class="woocommerce-Price-amount amount"><bdi><span
                                                    class="woocommerce-Price-currencySymbol">$</span>18.00</bdi></span></ins>
