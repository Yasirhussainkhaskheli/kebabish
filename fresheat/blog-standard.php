                    ...
                    <div class="news-standard-wrapper">
                        <div class="news-standard-items wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="blog-details.php">There are many Bad Effect Of junk food Restaurant</a>
                                </h3>
                                <p class="mb-3">
                                ...
                                <a href="blog-details.php" class="theme-btn mt-1">
                                    Read More
                        ...
                        <div class="news-standard-items wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="blog-details.php">There are many variations of Foods are available</a>
                                </h3>
                                <p class="mb-3">
                                    Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci
                                    malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum
                        ...
                        <div class="news-standard-items wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="blog-details.php">Avoid Health Risk Food Endure High Availability</a>
                                </h3>
                                <p class="mb-3">
                                    Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci
                                    malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum
                        ...
                        <div class="page-nav-wrap text-center">
                            <ul>
                                <li><a class="previous" href="blog-standard.php"><i
                                            class="fa-sharp fa-light fa-arrow-left-long"></i></a></li>
                                <li><a class="page-numbers" href="blog-standard.php">1</a></li>
                                <li><a class="page-numbers active" href="blog-standard.php">2</a></li>
                                <li><a class="page-numbers" href="blog-standard.php">3</a></li>
                                <li><a class="page-numbers" href="blog-standard.php">...</a></li>
                                <li><a class="next" href="blog-standard.php"> <i
                    ...
                    <div class="main-sidebar2">
                        ...
                        <div class="single-sidebar-widget wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="news-widget-categories">
                                <ul>
                                    <li><a href="blog-standard.php">Breakfast <span>(08)</span></a></li>
                                    <li><a href="blog-standard.php">Restaurant <span>(11)</span></a></li>
                                    <li class="active"><a href="blog-standard.php">Dinner <span>(12)</span></a></li>
                                    <li><a href="blog-standard.php">Fast Food <span>(18)</span></a></li>
                                    <li><a href="blog-standard.php">Launch<span>(07)</span></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="single-sidebar-widget wow fadeInUp" data-wow-delay=".9s">
                            ...
                            <div class="news-widget-categories">
                                <div class="tagcloud">
                                    <a href="blog-standard.php">Cheese</a>
                                    <a class="active" href="blog-standard.php">Cocktail</a>
                                    <a href="blog-standard.php">Drink</a>
                                    <a href="blog-standard.php">Uncategorized</a>
                                    <a href="blog-standard.php">Pizza</a>
                                    <a href="blog-standard.php">Non Veg</a>
                                </div>
                            </div>
                        </div>
                    </div>
