                ...
                <table class="cart_table">
                    ...
                    <tbody>
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cartname" href="shop-detailis.php">Brick Oven Pepperoni</a>
                            </td>
                            <td data-title="Price">
                        ...
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cartname" href="shop-detailis.php">Cheese Hand-Pizza</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cartname" href="shop-detailis.php">Over Loaded Vegan</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cartname" href="shop-detailis.php">Chicken Leg Piece</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="actions">
                                ...
                                <a href="cart.php" class="theme-btn">Update cart</a>
