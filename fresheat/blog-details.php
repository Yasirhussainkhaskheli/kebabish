                        ...
                        <div class="main-sidebar2">
                            ...
                            <div class="single-sidebar-widget wow fadeInUp" data-wow-delay=".4s">
                                ...
                                <div class="news-widget-categories">
                                    <ul>
                                        <li><a href="blog-details.php">Breakfast <span>(08)</span></a></li>
                                        <li><a href="blog-details.php">Restaurant <span>(11)</span></a></li>
                                        <li class="active"><a href="blog-details.php">Dinner <span>(12)</span></a></li>
                                        <li><a href="blog-details.php">Fast Food <span>(18)</span></a></li>
                                        <li><a href="blog-details.php">Launch<span>(07)</span></a></li>
                                    </ul>
                                </div>
                            </div>
